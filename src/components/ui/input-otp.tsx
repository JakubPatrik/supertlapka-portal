...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'border-input relative flex aspect-square items-center justify-center rounded-xl border text-base transition-all',
        isActive && 'border-ring ring-ring/30 ring-[3px]',
        className,
      )}
      {...props}
    >
